...
export const orderStatusConfig: Record<AdminOrderStatus, OrderStatusConfig> = {
  pending_review: { label: 'Pendiente de revision', colorClass: 'warning', group: 'review', order: 10 },
  ...
  in_production: { label: 'En produccion', colorClass: 'info', group: 'production', order: 60 },
