...
export const accesoriosEntries: CatalogEntry[] = [
  ...
  },
  {
    ...
    description: 'Pegatinas con troquel, material y acabado configurables.',
    shortDescription: 'Pegatinas para branding, packaging y exterior con compra clara.',
    route: '#/producto/pegatinas-personalizadas',
    purchaseMode: 'hybrid',
    pricingMode: 'volume',
    upload: { required: false, acceptedFormats: [...commonArtworkFormats] },
    configuratorFields: [...accessoryBaseFields, { key: 'file', type: 'file', label: 'Archivo', accept: '.pdf,.ai,.eps,.svg,.png,.jpg,.jpeg' }],
    legalNotes: defaultCommercialNoticeKeys,
    cta: { type: 'add_to_cart', href: '#/producto/pegatinas-personalizadas', label: 'Anadir al carrito' },
    manualReviewRequired: true,
    unitLabel: 'ud',
    tiers: [
  ...
  },
  {
    ...
    kind: 'product',
    category: 'accesorios',
    name: 'Pegatinas premium',
    description: 'Pegatinas premium con material, troquel y laminado configurables.',
    shortDescription: 'Pegatinas con materiales premium, exterior o transparente.',
    route: '#/producto/pegatinas-personalizadas',
    purchaseMode: 'hybrid',
    pricingMode: 'volume',
    upload: { required: false, acceptedFormats: [...commonArtworkFormats] },
