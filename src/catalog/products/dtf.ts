...
export const dtfEntry: CatalogEntry = {
  ...
  category: 'dtf',
  name: 'DTF por metro',
  description: 'Producto principal con configurador propio, previsualizacion, archivo y carrito listo.',
  shortDescription: 'DTF con flujo directo desde el archivo hasta el carrito.',
  route: '#/producto/dtf',
  purchaseMode: 'direct',
  pricingMode: 'unit',
  upload: {
  ...
  configuratorFields: [
    ...
    },
    {
      ...
      label: 'Urgencia',
      required: true,
      hint: 'Selecciona el ritmo de entrega que necesitas.',
      options: [
