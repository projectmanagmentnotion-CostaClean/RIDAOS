...
export const papeleriaEntries: CatalogEntry[] = [
  {
    ...
    shortDescription: 'Tarjetas por tirada con opcion de diseno y revision comercial.',
  ...
  },
  {
    ...
    shortDescription: 'Flyers por tirada con lectura directa y revision de archivo.',
    route: '#/producto/papeleria',
    purchaseMode: 'hybrid',
    pricingMode: 'volume',
  ...
  },
  {
    ...
    shortDescription: 'Papeleria ampliada sujeta a cantidad, formato y revision comercial.',
    route: '#/producto/papeleria',
    purchaseMode: 'quote',
    pricingMode: 'quote',
    upload: { required: false, acceptedFormats: [...commonArtworkFormats] },
