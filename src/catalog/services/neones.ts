...
export const neonesEntries: CatalogEntry[] = [
  {
    ...
    shortDescription: 'Neon decorativo con rango orientativo y confirmacion personalizada.',
  ...
  },
  {
    ...
    description: 'Formato circular, cuadrado o forma personalizada con medida maxima sujeta a comprobacion.',
    shortDescription: 'Neon especial sujeto a forma, colores y confirmacion comercial.',
    route: '#/servicios/neones',
    purchaseMode: 'quote',
    pricingMode: 'quote',
    upload: { required: false, acceptedFormats: [...commonArtworkFormats] },
