...
export const rotulacionEntries: CatalogEntry[] = [
  {
    ...
    shortDescription: 'Proyecto base para vehiculo con rango orientativo y propuesta a medida.',
  ...
  },
  {
    ...
    shortDescription: 'Semi-wrap con lectura de rango y propuesta comercial posterior.',
    route: '#/servicios/rotulacion',
    purchaseMode: 'quote',
    pricingMode: 'range',
    upload: { required: false, acceptedFormats: [...commonArtworkFormats] },
  ...
  },
  {
    ...
    shortDescription: 'Wrap integral con rango alto y propuesta previa obligatoria.',
    route: '#/servicios/rotulacion',
    purchaseMode: 'quote',
    pricingMode: 'range',
    upload: { required: false, acceptedFormats: [...commonArtworkFormats] },
